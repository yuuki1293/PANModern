...
public class BlockEntities {
    ...
    public static final Supplier<BlockEntityType<PANCoreBlockEntity>> PAN_CORE_BLOCK_ENTITY = BLOCK_ENTITY_TYPES.register(
        "pan_core",
        () -> BlockEntityType.Builder.of(
            PANCoreBlockEntity::new, Blocks.PAN_CORE_BLOCK.get()
        ).build(null));
}
