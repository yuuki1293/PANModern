...
object CraftingInputAdapter : IRecipeInputAdapter<CraftingInput> {
    override fun createInput(ingredients: List<ItemStack>): CraftingInput = CraftingInput.of(9, 9, ingredients.toNonNullList(81))
}

object SingleItemInputAdapter : IRecipeInputAdapter<SingleRecipeInput> {
    override fun createInput(ingredients: List<ItemStack>): SingleRecipeInput? = ingredients.firstNotNullOfOrNull { itemStack ->
...
private class ItemStackListRecipeInput(
